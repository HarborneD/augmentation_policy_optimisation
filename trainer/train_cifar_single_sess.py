...
import trainer.custom_ops as ops
import trainer.data_utils as data_utils
import trainer.helper_utils as helper_utils
import numpy as np
from trainer.shake_drop import build_shake_drop_model
from trainer.shake_shake import build_shake_shake_model
import tensorflow as tf
from trainer.wrn import build_wrn_model
...
class CifarModelTrainer(object):
  ...
  def single_session_create(self, m):
    """Creates a new session for model m."""
    # Create a new session for this model, initialize
    # variables, and save / restore from
    # checkpoint.
